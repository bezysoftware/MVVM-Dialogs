namespace Bezysoftware.Navigation.Dialogs.Lookup
{
    ...
    /// </summary>
    public class AssociatedDialogViewModelAttribute : AssociatedViewModelAttribute
    {
        public readonly Type DialogType;

        public AssociatedDialogViewModelAttribute(Type viewModel, Type dialogType) : base(viewModel)
        {
